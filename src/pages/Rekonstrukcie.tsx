...
import { Plus, Minus, HardHat, ChevronLeft, ChevronRight, Clock, ShieldCheck, Check, Hammer, CheckCircle, Phone, Scissors, Sparkles, MapPin, Mail } from 'lucide-react';
...
const servicesData = [
  {
    id: "01",
    title: "Búracie práce a likvidácia sutiny",
    desc: "Bezpečne odstránime pôvodné konštrukcie, priečky, podlahy a vybavenie vrátane odvozu a likvidácie odpadu.",
    bullets: ["Demontáž", "Búracie práce", "Odvoz sutiny"],
    img: "/desmostav-hruba-stavba-35.webp"
  },
  {
    id: "02",
    title: "Elektroinštalácie a vodoinštalácie",
    desc: "Kompletné nové rozvody elektriny, vody a odpadu podľa platných noriem a s certifikátom.",
    bullets: ["Nové káblové trasy", "Vodovodné potrubia", "Revízna správa"],
    img: "/desmostav-kompletna-rekonstrukcia-16.webp"
  },
  {
    id: "03",
    title: "Stierkovanie a maľovanie",
    desc: "Vyrovnanie stien, nanesenie kvalitných stierok a precízne maľovanie pre dokonalý vzhľad interiéru.",
    bullets: ["Sieťkovanie a omietky", "Hladké stierky", "Profesionálna maľovka"],
    img: "/desmostav-kompletna-rekonstrukcia-16.webp"
  },
  {
    id: "04",
    title: "Obklady, dlažby a podlahy",
    desc: "Kladenie všetkých typov podláh, dlažieb a obkladov s dôrazom na detail a presnosť škár.",
    bullets: ["Keramické obklady", "Plávajúce podlahy", "Vinylové dielce"],
    img: "/desmostav-kompletna-rekonstrukcia-25.webp"
  },
  {
    id: "05",
    title: "Rekonštrukcia bytového jadra",
    desc: "Premena starého umakartového jadra na modernú murovanú kúpeľňu spojenú so záchodom alebo samostatne.",
    bullets: ["Vymurovanie priečok", "Nová sanita", "Hydroizolácia"],
    img: "/desmostav-kompletna-rekonstrukcia-34.webp"
  },
  {
    id: "06",
    title: "Kompletné rekonštrukcie",
    desc: "Realizácia rekonštrukcie 'na kľúč', kde odovzdáme kompletne hotový byt pripravený na nasťahovanie.",
    bullets: ["Projektový manažment", "Koordinácia remesiel", "Finálne upratovanie"],
    img: "/desmostav-prerabka-domu-01.webp"
  }
];

export default function Rekonstrukcie() {
      ...
      <div className="w-full max-w-[428px] bg-[#F5F5F5] shadow-2xl relative flex flex-col h-[100dvh] overflow-y-auto overflow-x-hidden">
        ...
        <section className="relative h-[65dvh] min-h-[450px] shrink-0 flex flex-col justify-end pb-12">
          ...
          <div className="relative z-10 px-6 flex flex-col items-start">
            ...
            <h1 className="text-[42px] font-extrabold tracking-tight text-white mb-4 uppercase leading-[1.05]">
              KOMPLETNÉ <br /> <span className="text-[#E5A93B]">REKONŠTRUKCIE</span>
            </h1>
            <p className="text-[15px] text-gray-200 mb-6 font-medium max-w-[280px] leading-[1.6]">
              Kompletné rekonštrukcie domov a bytov vrátane prerábky bytových jadier a kúpeľní na kľúč.
            </p>
        ...
        <section className="pt-12 pb-6 px-6 bg-[#F5F5F5]">
          <div className="relative flex flex-col items-center text-center">
            ...
            <h2 className="text-[32px] font-extrabold text-[#1A1A1A] leading-[1.15] mb-7 relative z-10 tracking-tight">
              Dajte svojmu domovu <br/> <span className="text-[#E5A93B]">nový dych</span>
            </h2>
            ...
            <div className="flex flex-col items-center text-center w-full max-w-[340px] relative z-10">
              <p className="text-[15px] text-gray-700 font-medium leading-[1.6] mb-8">
                Či už ide o rekonštrukciu bytového jadra, kúpeľne, alebo kompletnú prestavbu celého domu, sme tu pre vás.
              </p>
        ...
        >
          ...
          <div ref={carouselRef} className="flex overflow-x-auto snap-x snap-mandatory gap-4 w-full pb-6 px-6 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              ...
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">1. OBHLIADKA A NÁVRH</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Zhodnotíme stav vašej nehnuteľnosti, vypočujeme si vaše predstavy a pripravíme podrobný plán prác a rozpočet.
              </p>
              <span className="absolute bottom-7 right-7 text-[11px] font-bold text-gray-300">1 / 3</span>
            </div>
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              <div className="w-12 h-12 rounded-full bg-[#F5F5F5] flex items-center justify-center mb-5">
                <CheckCircle className="w-5 h-5 text-[#E5A93B]" />
              </div>
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">2. PRÍPRAVA A BÚRANIE</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Pripravíme priestor na prácu, bezpečne odstránime staré jadro a podlahy, a všetok odpad ihneď ekologicky zlikvidujeme.
              </p>
            ...
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              ...
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">3. REALIZÁCIA A ODOVZDANIE</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Zrealizujeme inštalácie, stierky, obklady a zariaďovacie predmety. Po finálnom uprataní odovzdávame dielo pripravené na užívanie.
              </p>
        ...
        <section className="py-8 px-6 bg-[#F5F5F5] border-t border-[#E5A93B]/10">
          ...
          <div className="flex flex-col gap-4">
            <FaqAccordion question="Ako dlho trvá rekonštrukcia bytu?" answer="V závislosti od rozsahu prác a veľkosti priestoru trvá kompletná rekonštrukcia zvyčajne 4 až 8 týždňov." />
            <FaqAccordion question="Zabezpečujete aj odvoz stavebného odpadu?" answer="Áno, všetky búracie práce zahŕňajú aj kompletný odvoz a ekologickú likvidáciu sutiny." />
            <FaqAccordion question="Pomôžete mi aj s návrhom a výberom materiálov?" answer="Samozrejme, radi vám poradíme s výberom obkladov, podláh aj sanity pre ideálny výsledok." />
            <FaqAccordion question="Je potrebná obhliadka pred vypracovaním ponuky?" answer="Áno, bezplatná obhliadka je kľúčová pre presné zameranie a odhad nákladov rekonštrukcie." />
            <FaqAccordion question="Poskytujete záruku na vykonané práce?" answer="Na všetky naše rekonštrukčné práce poskytujeme štandardnú záruku a garantujeme kvalitu." />
          </div>
        </section>
        ...
        <section className="pt-8 pb-8 px-6 bg-[#F5F5F5] flex flex-col items-center text-center">
          <span className="text-[14px] font-extrabold tracking-widest text-[#E5A93B] uppercase leading-[1.6] max-w-[320px]">
            DAJTE VÁŠMU BÝVANIU NOVÝ DYCH A MODERNÝ VZHĽAD.
          </span>
        </section>
        ...
        <section className="px-6 pt-8 pb-12 bg-[#F5F5F5]">
          <div className="bg-[#F5F5F5] rounded-[1.5rem] p-6 flex flex-col items-center text-center shadow-sm border border-black/5">
            ...
            <h3 className="text-[18px] font-extrabold text-[#1A1A1A] mb-2 leading-tight">
              Plánujete rekonštrukciu <br /> vášho bývania?
            </h3>
          ...
          <div className="flex flex-col gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-400 text-[13px] font-medium leading-relaxed max-w-[250px]">
                Profesionálne stavebné služby pre bývanie, ktoré si zamilujete každý deň.
              </p>
            </div>
