...
const servicesData = [
  {
    ...
    desc: "Kompletné a bezpečné káblové rozvody vrátane zapojenia koncových zariadení.",
    bullets: ["Rozvody", "Zásuvky", "Osvetlenie", "Ističe"]
  },
  {
    id: "02",
    title: "Vodoinštalácie",
    desc: "Nové aj rekonštruované vodovodné a kanalizačné siete pre váš domov.",
    bullets: ["Rozvody vody", "Odpady", "Armatúry", "Príprava technológií"]
  },
  {
    id: "03",
    title: "Vykurovanie",
    desc: "Efektívne a moderné systémy vykurovania pre maximálny tepelný komfort.",
    bullets: ["Radiátory", "Podlahové kúrenie", "Rozvody", "Technické riešenia"]
  },
  {
    id: "04",
    title: "Technické inštalácie",
    desc: "Pokročilé technológie pre úpravu klímy a inteligentné riadenie domácnosti.",
    bullets: ["Klimatizácia", "Vzduchotechnika", "Inteligentná domácnosť"]
  }
];

export default function Instalacie() {
    ...
    <div className="fixed inset-0 bg-[#E5E5E5] font-sans text-gray-900 flex justify-center overflow-hidden">
      <div className="w-full max-w-[428px] bg-[#F5F5F5] shadow-2xl relative flex flex-col h-[100dvh] overflow-y-auto overflow-x-hidden">
        ...
        <section className="relative h-[65dvh] min-h-[450px] shrink-0 flex flex-col justify-end pb-12">
          ...
          <div className="relative z-10 px-6 flex flex-col items-start">
            ...
            <h1 className="text-[42px] font-extrabold tracking-tight text-white mb-4 uppercase leading-[1.05]">
              TECHNICKÉ <br /> <span className="text-[#E5A93B]">INŠTALÁCIE</span>
            </h1>
            <p className="text-[15px] text-gray-200 mb-6 font-medium max-w-[280px] leading-[1.6]">
              Elektroinštalácie, vodoinštalácie, kúrenie, klimatizácie a technické riešenia stavieb.
            </p>
        ...
        <section className="w-full h-[30vh] min-h-[250px] relative flex flex-col items-center justify-center overflow-hidden bg-[#111111]">
          <img
            src="/desmostav-hruba-stavba-26.webp"
            alt="Banner detail"
