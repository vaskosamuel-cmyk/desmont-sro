...
import { HardHat, ChevronLeft, ChevronRight, Clock, ShieldCheck, Check, Calendar, Phone, Hammer, Scissors, Sparkles, MapPin, Mail } from 'lucide-react';
...
export default function StavbyNaKluc() {
  const galleryImages = [
  ...
  return (
    <div className="fixed inset-0 bg-[#E5E5E5] font-sans text-gray-900 flex justify-center overflow-hidden">
      <div className="w-full max-w-[428px] bg-[#F5F5F5] shadow-2xl relative flex flex-col h-[100dvh] overflow-y-auto overflow-x-hidden">
        ...
        <section className="relative h-[65dvh] min-h-[450px] shrink-0 flex flex-col justify-end pb-12">
          ...
          <div className="relative z-10 px-6 flex flex-col items-start">
            ...
            <p className="text-[15px] text-gray-200 mb-6 font-medium max-w-[280px] leading-[1.6]">
              Kompletná výstavba rodinných domov od základovej dosky až po odovzdanie.
            </p>
            ...
            <div className="flex items-center gap-2 mt-1 mb-2">
              ...
              <span className="text-white text-[13px] font-bold tracking-wide drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                4.9 · <span className="font-medium text-gray-300">Google</span>
              </span>
            </div>
          </div>
        ...
        <section className="pt-12 pb-6 px-6 bg-[#F5F5F5]">
          <div className="relative flex flex-col items-center text-center">
            ...
            <h2 className="text-[32px] font-extrabold text-[#1A1A1A] leading-[1.15] mb-7 relative z-10 tracking-tight">
              Váš nový domov <br/> <span className="text-[#E5A93B]">bez starostí</span>
            </h2>
            ...
            <div className="flex flex-col items-center text-center w-full max-w-[340px] relative z-10">
              <p className="text-[15px] text-gray-700 font-medium leading-[1.6] mb-8">
                Postaráme sa o kompletnú realizáciu od výkopov až po finálne odovzdanie kľúčov. S nami máte istotu dodržania termínov a rozpočtu.
              </p>
        ...
        {/* What is included */}
        <section className="py-8 px-6 bg-[#F5F5F5]">
          <div className="bg-[#FAF9F5] rounded-[1.5rem] p-6 shadow-sm border border-black/5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-4 border-b border-gray-200 pb-4">
                <div className="w-6 h-6 rounded-full bg-[#E5A93B] flex items-center justify-center shrink-0">
                  <Check className="w-4 h-4 text-white" strokeWidth={2} />
                </div>
                <span className="text-[13px] font-medium text-[#1A1A1A]">Základová doska a hrubá stavba</span>
              </div>
              ...
              <div className="flex items-center gap-4 border-b border-gray-200 pb-4">
                ...
                <span className="text-[13px] font-medium text-[#1A1A1A]">Rozvody, inštalácie a kúrenie</span>
              </div>
              ...
              <div className="flex items-center gap-4 border-b border-gray-200 pb-4">
                ...
                <span className="text-[13px] font-medium text-[#1A1A1A]">Omietky, potery a sadrokartóny</span>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-[13px] font-medium text-[#1A1A1A]">Finálne dokončenie a kolaudácia</span>
              </div>
            </div>

            <div className="w-full h-[180px] rounded-xl overflow-hidden mt-2">
              <img 
                src="/desmostav-stavebne-prace-02.webp" 
                alt="Detail služby"
          ...
          <button onClick={openSheet}
              className="w-full bg-[#1A1A1A] hover:bg-[#E5A93B] text-white transition-colors font-bold py-3.5 px-6 rounded-xl flex items-center justify-center gap-3 mt-4 shadow-md"
            >
        ...
        >
          ...
          <div ref={carouselRef} className="flex overflow-x-auto snap-x snap-mandatory gap-4 w-full pb-6 px-6 [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              ...
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">SKÚSENÝ TÍM</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Každá stavba si vyžaduje profesionálny a zodpovedný prístup.
              </p>
            ...
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              ...
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">ČISTOTA A PORIADOK</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Stavba, ktorá bezpečne slúži generáciám a prináša radosť z bývania.
              </p>
            ...
            <div className="min-w-[85%] sm:min-w-[280px] snap-center flex flex-col bg-white rounded-[1.5rem] p-7 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 items-start text-left relative">
              ...
              <h3 className="text-[14px] font-extrabold text-[#1A1A1A] mb-3 uppercase tracking-wide">MODERNÉ RIEŠENIA</h3>
              <p className="text-[14px] text-gray-600 font-medium leading-relaxed pr-6">
                Moderné stavebné postupy a certifikované materiály pre maximálnu kvalitu.
              </p>
        ...
        <section className="py-8 px-6 bg-[#F5F5F5] border-t border-[#E5A93B]/10">
          ...
          <div className="flex flex-col gap-4">
            <FaqAccordion question="Ako dlho trvá výstavba domu na kľúč?" answer="Čas výstavby závisí od veľkosti a technológie, spravidla od 6 do 12 mesiacov od vydania stavebného povolenia." />
            <FaqAccordion question="Zabezpečíte aj stavebné povolenie?" answer="Áno, poskytujeme kompletný inžiniering vrátane všetkých potrebných dokumentov a komunikácie s úradmi." />
            <FaqAccordion question="Poskytujete záruku na vaše stavby?" answer="Samozrejme, na naše realizované diela poskytujeme predĺženú záruku a garantujeme kvalitu odvedených prác." />
            <FaqAccordion question="Môžeme zasahovať do projektu počas výstavby?" answer="Áno, drobné klientské zmeny sú možné, pričom s vami vždy konzultujeme ich vplyv na rozpočet a termín." />
            <FaqAccordion question="Ako prebieha financovanie?" answer="Financovanie nastavujeme fázovo na základe vopred schváleného harmonogramu prác a rozpočtu." />
          </div>
        </section>
        ...
        <section className="w-full h-[30vh] min-h-[250px] relative flex flex-col items-center justify-center overflow-hidden bg-[#111111]">
          <img
            src="/desmostav-stavebne-prace-11.webp"
            alt="Banner detail"
        ...
        <section className="pt-8 pb-8 px-6 bg-[#F5F5F5] flex flex-col items-center text-center">
          <span className="text-[14px] font-extrabold tracking-widest text-[#E5A93B] uppercase leading-[1.6] max-w-[320px]">
            VÁŠ VYSNÍVANÝ DOM ZAČÍNA KVALITNOU STAVBOU.
          </span>
        </section>
